...
public:
    ...
    void setupUi(QMainWindow *EditTapes)
    {
        ...
        zLabel_2->setMargin(1);

        zBSymLayout->addWidget(zLabel_2);

        blankSymLEdit = new QLineEdit(zCentralwidget);
        blankSymLEdit->setObjectName(QStringLiteral("blankSymLEdit"));
        QSizePolicy sizePolicy1(QSizePolicy::Preferred, QSizePolicy::Preferred);
        sizePolicy1.setHorizontalStretch(0);
        sizePolicy1.setVerticalStretch(0);
        sizePolicy1.setHeightForWidth(blankSymLEdit->sizePolicy().hasHeightForWidth());
        blankSymLEdit->setSizePolicy(sizePolicy1);
        blankSymLEdit->setMaximumSize(QSize(40, 16777215));
        QFont font1;
        font1.setPointSize(12);
        blankSymLEdit->setFont(font1);
        blankSymLEdit->setMaxLength(1);
        blankSymLEdit->setAlignment(Qt::AlignCenter);

        zBSymLayout->addWidget(blankSymLEdit);
    ...
    void retranslateUi(QMainWindow *EditTapes)
    {
        ...
        zLabel_2->setText(QApplication::translate("EditTapes", "Blank Symbol:", nullptr));
