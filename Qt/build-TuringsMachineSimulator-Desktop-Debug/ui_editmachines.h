...
public:
    ...
    {
        EditMachines->setWindowTitle(QApplication::translate("EditMachines", "MainWindow", Q_NULLPTR));
        label->setText(QApplication::translate("EditMachines", "Select the Cell you want to Edit", Q_NULLPTR));
        writeLabel->setText(QApplication::translate("EditMachines", "Write Symbol", Q_NULLPTR));
        moveLabel->setText(QApplication::translate("EditMachines", "Move Tape", Q_NULLPTR));
        nextLabel->setText(QApplication::translate("EditMachines", "Next State", Q_NULLPTR));
        changeBut->setText(QApplication::translate("EditMachines", "Change", Q_NULLPTR));
        saveBut->setText(QApplication::translate("EditMachines", "Save", Q_NULLPTR));
    } // retranslateUi
